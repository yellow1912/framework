...
namespace Zepluf\Bundle\StoreBundle\Tests\Component\Pricing\Handler;

use Zepluf\Bundle\StoreBundle\Tests\BaseTestCase;
use Zepluf\Bundle\StoreBundle\Component\Pricing\Handler\ProductDiscountPriceHandler;
...
//            ->will($this->returnValue(true));
        ...
        $productDiscountPriceHandler = new ProductDiscountPriceHandler($productComponent);
