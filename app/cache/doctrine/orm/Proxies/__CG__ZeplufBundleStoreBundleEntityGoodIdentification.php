 ...
 */
class GoodIdentification extends \Zepluf\Bundle\StoreBundle\Entity\GoodIdentification implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setGoodentificationType($goodentificationType);
    }

    public function getGoodentificationType()
    {
        $this->__load();
        return parent::getGoodentificationType();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'value', 'goodentificationType', 'product');
    }
