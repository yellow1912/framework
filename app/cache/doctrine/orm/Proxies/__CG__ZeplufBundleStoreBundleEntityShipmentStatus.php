 ...
 */
class ShipmentStatus extends \Zepluf\Bundle\StoreBundle\Entity\ShipmentStatus implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setShipmentStatusType($shipmentStatusType);
    }

    public function getShipmentStatusType()
    {
        $this->__load();
        return parent::getShipmentStatusType();
    }


    public function __sleep()
    {
        return array('__isInitialized__', 'id', 'date', 'shipment', 'shipmentStatusType');
    }
