 ...
 */
class Container extends \Zepluf\Bundle\StoreBundle\Entity\Container implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setContainerType($containerType);
    }

    public function getContainerType()
    {
        $this->__load();
        return parent::getContainerType();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'containerType', 'facility');
    }
