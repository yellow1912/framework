 ...
 */
class Order extends \Zepluf\Bundle\StoreBundle\Entity\Order implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'type', 'orderDate', 'entryDate');
    }
