...
class Product extends \Zepluf\Bundle\StoreBundle\Entity\Product implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'type', 'name', 'description', 'introductionDate', 'salesDiscontinuationDate', 'availableDate', 'priceComponent', 'termType', 'manufacturer', 'unitOfMeasurement');
    }
