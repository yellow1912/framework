 ...
 */
class OrderShipment extends \Zepluf\Bundle\StoreBundle\Entity\OrderShipment implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setShippedQuantity($shippedQuantity);
    }

    public function getShippedQuantity()
    {
        $this->__load();
        return parent::getShippedQuantity();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'shippedQuantity', 'shipmentItem', 'orderItem');
    }
