 ...
 */
class OrderStatus extends \Zepluf\Bundle\StoreBundle\Entity\OrderStatus implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setOrderStatusType($orderStatusType);
    }

    public function getOrderStatusType()
    {
        $this->__load();
        return parent::getOrderStatusType();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'entryDate', 'order', 'orderStatusType', 'orderItem');
    }
