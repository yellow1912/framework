 ...
 */
class Carrier extends \Zepluf\Bundle\StoreBundle\Entity\Carrier implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::addShipmentMethodType($shipmentMethodType);
    }

    public function removeShipmentMethodType(\Zepluf\Bundle\StoreBundle\Entity\ShipmentMethodType $shipmentMethodType)
    {
        $this->__load();
        return parent::removeShipmentMethodType($shipmentMethodType);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'shipmentMethodType');
    }
