 ...
 */
class ProductFeatureApplicability extends \Zepluf\Bundle\StoreBundle\Entity\ProductFeatureApplicability implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'type', 'fromDate', 'throughDate', 'product', 'productFeature');
    }
